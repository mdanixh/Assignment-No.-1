//Your Own Array Task
var motorbikes = ["BMW R1200", "Banelli TRK 502", "Yamaha YBR 125G"];
...
// not the indices.
for (var _i = 0, motorbikes_1 = motorbikes; _i < motorbikes_1.length; _i++) {
    var motorbike = motorbikes_1[_i];
    console.log("I would like to own a ".concat(motorbike, "."));
}
