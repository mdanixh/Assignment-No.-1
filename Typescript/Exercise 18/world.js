...
var locations = ["Ormara", "Moola Chotok", "Ornach Valley", "Ziarat", "ChaparRift"];
//2. Print the array in its original order
console.log("Original Order:", locations);
//3. Create a copy of that array and sort it in alphabetical order
var sortedAlphabetically = __spreadArray([], locations, true).sort();
...
var sortedReverse = __spreadArray([], locations, true).sort().reverse();
